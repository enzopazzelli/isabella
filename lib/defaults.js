...
export const defaultProductos = [
  ...
  },
  {
    ...
    colores: [
      { nombre: 'Negro', hex: '#000000', imagen: '/imgs/IMG_9972.PNG' },
      { nombre: 'Blanco', hex: '#FFFFFF', imagen: '/imgs/IMG_9968.PNG' },
      { nombre: 'Gris', hex: '#888888', imagen: '/imgs/IMG_9976.PNG' },
    ],
  },
  {
  ...
  },
  {
    ...
    colores: [
      { nombre: 'Crudo', hex: '#F3EDE8', imagen: '/imgs/IMG_9977.PNG' },
      { nombre: 'Bordo', hex: '#722F37', imagen: '/imgs/IMG_9973.PNG' },
    ],
  },
  {
  ...
  // — Hombre —
  {
    ...
    badge: 'NUEVO', imagenes: ['/imgs/IMG_9970.PNG'], stock: 10, disponible: true, orden: 17,
  },
  {
    ...
    badge: null, imagenes: ['/imgs/IMG_9975.PNG'], stock: 20, disponible: true, orden: 18,
  },
  {
    ...
    badge: null, imagenes: ['/imgs/IMG_9972.PNG'], stock: 25, disponible: true, orden: 19,
  },
  // — Kids —
  {
    ...
    badge: 'NUEVO', imagenes: ['/imgs/IMG_9977.PNG'], stock: 15, disponible: true, orden: 20,
  },
  {
    ...
    badge: null, imagenes: ['/imgs/IMG_9975.PNG'], stock: 18, disponible: true, orden: 21,
  },
]
